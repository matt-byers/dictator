...
Whisper Dictate needs macOS Microphone, Input Monitoring, and Accessibility permissions to perform its core function. It does not need network access after the model has been downloaded, although the first model use contacts Hugging Face.
